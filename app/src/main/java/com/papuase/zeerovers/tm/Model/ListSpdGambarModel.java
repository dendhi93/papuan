...
public class ListSpdGambarModel {
    ...
    public ListSpdGambarModel(String id, String file_url, String description, String VID, String NoTask, String catatanTransaksi, String jenisBiaya, String nominal, String tglInputBiaya, String file_id) {
        this.id = id;
